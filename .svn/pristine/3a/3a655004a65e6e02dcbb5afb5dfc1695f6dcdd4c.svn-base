...
public class GenerateAssistintTicket {
   ...
   /* public String generatePictuerTicket(){
    ...
    public String test() {
       ...
       // WeChatOrderInfoEntity orderInfoEntity = weChatOrderInfoService.findOrderInfoByOrderId("1");
       // weChatOrderInfoService.refund(orderInfoEntity,50.0);
        rewardWithdrawService.withDraw(10.0,"oy6Qtw6pICdD86JKObwBdoV3cZjA");
        return "";
    }
}
